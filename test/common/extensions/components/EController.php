...
class EController extends CController
{
	...
	public $breadcrumbs;
	public $top_title='';//定义顶部文字
    public $top_title_url = '';//对应的返回链接，空则默认为refer
	public $top_menus=[];
...
//    public $top_member_list = [];    //测试信息 debug模式的时候生成列表时候用到的，上线的时候必须要删掉

    public $inviteinfo = [];    //实现全局的微信邀请功能
    public $ishavnewnotice = 0; //是否有未读通知
